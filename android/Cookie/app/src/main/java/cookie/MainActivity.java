...
/*
    ...
    - fix cycle
    - fix restore
    - stats fragment bottom margin
    - title animation
    - more upgrades & achievements
    - settings
 */
public class MainActivity extends ActionBarActivity {
    ...
    CpsChangedListener cpsListener;
    Runnable subtitleRunnable, titleRunnable;
    double titleCookies;
    ...
    public void showGoldenCookie(final int secs){
        if(!visible) return;
