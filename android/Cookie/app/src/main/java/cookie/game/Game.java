...
public class Game {
    ...
    public static double calculateHeavenlyChips() {
        ...
        long trillions = (long) (Stats.getAllTimeCookies() / 1000000000000.0);
        long hc = (long) (Math.sqrt(8 * trillions + 1) - 1) / 2;
        return hc - Stats.heavenlyChips;
    }
    ...
    /*public static class AchievementManager{
        ...
        public static void softReset() {
            ...
            long trillones = (long)(Stats.profited/1000000000000.0);
            ...
            GoldenCookie.secondsLeft = 10 * 480;
