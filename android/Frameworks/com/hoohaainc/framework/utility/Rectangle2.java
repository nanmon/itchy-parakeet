...
public class Rectangle2 {
    ...
    public Rectangle2 offSetCopy(int diffX, int diffY){
        return new Rectangle2(x + diffX, y + diffY, width, height);
    }

    public Rectangle2 offSetCopy(Vector2 diff){
        return new Rectangle2(x + (int)diff.x, y + (int)diff.y, width, height);
    }
